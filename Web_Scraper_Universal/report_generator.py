...
class ReportGenerator:
    def __init__(self, base_dir: str = None):
        """
        Initialize Report Generator with configurable base directory

        Args:
            base_dir: Base directory for reports and charts. If None, uses current directory
        """
        if base_dir is None:
            # Use current script directory or user-specified location
            base_dir = os.path.join(str(Path.home()), "Documents", "Reports")
